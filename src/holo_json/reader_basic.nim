...
import ./[common, parser, read_helpers], holo_map/[caseutils, variants], holo_flow/holo_reader
...
proc read*(format: JsonReadFormat, reader: var HoloReader, v: var cstring) {.inline.} =
  ## Parse cstring.
  ## 
